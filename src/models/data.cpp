...
void BottomUpResults::addTracepointCost(int type, const QVector<qint32>& frames, quint64 cost)
{
    auto parent = &root;
    foreachFrame(frames, [this, type, cost, &parent](const Data::Symbol& symbol, const Data::Location& /*location*/) {
