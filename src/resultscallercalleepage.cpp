    ...
    , ui(new Ui::ResultsCallerCalleePage)
{
    ...
    connect(parser, &PerfParser::callerCalleeDataAvailable, this,
            [this, parser](const Data::CallerCalleeResults& data) {
                ...
                ResultsUtil::hideTracepointColumns(data.inclusiveCosts, ui->callerCalleeTableView,
                ...
                ResultsUtil::hideTracepointColumns(data.inclusiveCosts, ui->callersView, CallerModel::NUM_BASE_COLUMNS,
                                                   parser->tracepointCostNames());
                ResultsUtil::hideEmptyColumns(data.inclusiveCosts, ui->calleesView, CalleeModel::NUM_BASE_COLUMNS);
                ResultsUtil::hideTracepointColumns(data.inclusiveCosts, ui->calleesView, CalleeModel::NUM_BASE_COLUMNS,
                                                   parser->tracepointCostNames());
                ResultsUtil::hideEmptyColumns(data.inclusiveCosts, ui->sourceMapView, SourceMapModel::NUM_BASE_COLUMNS);
                ResultsUtil::hideTracepointColumns(data.inclusiveCosts, ui->sourceMapView,
                                                   SourceMapModel::NUM_BASE_COLUMNS, parser->tracepointCostNames());
